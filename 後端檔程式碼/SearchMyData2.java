...
@WebServlet("/SMD3")
public class SearchMyData2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try{ 
		    ...
		    //out.print(time.format(nowDate));
		    String time2=String.valueOf(time.format(nowDate));
		    //out.print(time2);
	    	//getsql=request.getParameter("Test1");
		    getsql=time2;
	        String sql= "select * from 購物車 where 訂單編號  LIKE '%"+getsql+"%'";
	        rs = stmt.executeQuery(sql);
	        out.print("<body background=\"7eat.png\">");
	        out.print("<center><table border='8' width='600' bgcolor='"+"white"+"'><tr>");
	        out.print("<th>訂單編號</th><th><font color='"+fontColorOrange+"'>餐點編號</th><th><font color='"+fontColorBlue+"' >店家</th><th><font color='"+fontColorPurple+"' >便當</th><th><font color='"+fontColorGold+"' >價格</th></tr>");

	        while(rs.next())
	        {
	        	line="<tr><td align=center>";
	        	line=line+rs.getString("訂單編號")+"</td><td align=center><font color='"+fontColorOrange+"' >";
